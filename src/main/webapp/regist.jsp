...
<div class="row center" style="margin-top:120px;">  
  <div class="col-md-5 col-sm-offset-4">  
    <div class="well col-md-10">  
       <h3>用户注册</h3>  
       <div>
          <span style="font-size: 16px;"><font color="red"></font></span><br/>
          <span style="font-size: 16px;"><font color="red"></font></span>
       </div>
       <form action="${pageContext.request.contextPath}/regist.action" method="post" onsubmit="return check()">
		    ...
		    <div class="input-group input-group-md">  
		          ...
		          <input type="password" class="form-control" id="upassword" name="password" placeholder="密码" aria-describedby="sizing-addon1">  
		    </div>
		    <div class="input-group input-group-md">  
		          <span class="input-group-addon" id="sizing-addon1"><i class="glyphicon glyphicon-lock"></i></span>  
		          <input type="password" class="form-control" id="repassword" name="repassword" placeholder="确认密码" aria-describedby="sizing-addon1">  
		    </div>
		    <div>
